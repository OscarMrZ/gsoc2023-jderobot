...
#ifndef PATROLLING_EXAMPLE__CTRL_SUPPORT__BTLIFECYCLECTRLNODE_HPP_
#define PATROLLING_EXAMPLE__CTRL_SUPPORT__BTLIFECYCLECTRLNODE_HPP_
...
#endif  // patrolling_example__CTRL_SUPPORT__BTLIFECYCLECTRLNODE_HPP_
