...
int main(int argc, char * argv[])
{
  ...
  auto node = rclcpp::Node::make_shared("example_patrolling");

  BT::BehaviorTreeFactory factory;
  BT::SharedLibrary loader;

  factory.registerFromPlugin(loader.getOSName("battery_checker_bt_node"));
  factory.registerFromPlugin(loader.getOSName("location_bt_node"));
  ...
  std::string pkgpath = ament_index_cpp::get_package_share_directory("patrolling_example");
  std::string xml_file = pkgpath + "/behavior_tree_xml/example.xml";
